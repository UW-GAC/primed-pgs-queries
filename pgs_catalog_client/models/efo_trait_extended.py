...
import six
from pgs_catalog_client.models.efo_trait import EFOTrait  # noqa: F401,E501

class EFOTraitExtended(EFOTrait):
    ...
    if hasattr(EFOTrait, "swagger_types"):
        swagger_types.update(EFOTrait.swagger_types)
    ...
    if hasattr(EFOTrait, "attribute_map"):
        attribute_map.update(EFOTrait.attribute_map)

    def __init__(self, trait_categories=None, trait_synonyms=None, trait_mapped_terms=None, associated_pgs_ids=None, *args, **kwargs):  # noqa: E501
        """EFOTraitExtended - a model defined in Swagger"""  # noqa: E501
        ...
        EFOTrait.__init__(self, *args, **kwargs)

    @property
    def trait_categories(self):
        """Gets the trait_categories of this EFOTraitExtended.  # noqa: E501

        List of trait categories associated with the trait  # noqa: E501

        :return: The trait_categories of this EFOTraitExtended.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def trait_categories(self, trait_categories):
        """Sets the trait_categories of this EFOTraitExtended.

        List of trait categories associated with the trait  # noqa: E501

        :param trait_categories: The trait_categories of this EFOTraitExtended.  # noqa: E501
        :type: list[str]
        """
    ...
    def trait_synonyms(self):
        """Gets the trait_synonyms of this EFOTraitExtended.  # noqa: E501

        List of associated trait synonyms  # noqa: E501

        :return: The trait_synonyms of this EFOTraitExtended.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def trait_synonyms(self, trait_synonyms):
        """Sets the trait_synonyms of this EFOTraitExtended.

        List of associated trait synonyms  # noqa: E501

        :param trait_synonyms: The trait_synonyms of this EFOTraitExtended.  # noqa: E501
        :type: list[str]
        """
    ...
    def trait_mapped_terms(self):
        """Gets the trait_mapped_terms of this EFOTraitExtended.  # noqa: E501

        List of associated external references/IDs  # noqa: E501

        :return: The trait_mapped_terms of this EFOTraitExtended.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def trait_mapped_terms(self, trait_mapped_terms):
        """Sets the trait_mapped_terms of this EFOTraitExtended.

        List of associated external references/IDs  # noqa: E501

        :param trait_mapped_terms: The trait_mapped_terms of this EFOTraitExtended.  # noqa: E501
        :type: list[str]
        """
    ...
    def associated_pgs_ids(self):
        """Gets the associated_pgs_ids of this EFOTraitExtended.  # noqa: E501

        List of associated Polygenic Score IDs  # noqa: E501

        :return: The associated_pgs_ids of this EFOTraitExtended.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def associated_pgs_ids(self, associated_pgs_ids):
        """Sets the associated_pgs_ids of this EFOTraitExtended.

        List of associated Polygenic Score IDs  # noqa: E501

        :param associated_pgs_ids: The associated_pgs_ids of this EFOTraitExtended.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EFOTraitExtended, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EFOTraitExtended):
            return False
