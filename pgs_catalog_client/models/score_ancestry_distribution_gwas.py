...
class ScoreAncestryDistributionGwas(object):
    ...
    def __init__(self, dist=None, count=None, multi=None):  # noqa: E501
        """ScoreAncestryDistributionGwas - a model defined in Swagger"""  # noqa: E501
        self._dist = None
        self._count = None
        self._multi = None
    ...
    @property
    def dist(self):
        """Gets the dist of this ScoreAncestryDistributionGwas.  # noqa: E501

        Ancestry distribution. The endpoint **/rest/ancestry_categories** provides the mapping between the 3 letters symbol and the ancestry category name.  # noqa: E501

        :return: The dist of this ScoreAncestryDistributionGwas.  # noqa: E501
        :rtype: dict(str, int)
        """
        return self._dist
    ...
    @dist.setter
    def dist(self, dist):
        """Sets the dist of this ScoreAncestryDistributionGwas.

        Ancestry distribution. The endpoint **/rest/ancestry_categories** provides the mapping between the 3 letters symbol and the ancestry category name.  # noqa: E501

        :param dist: The dist of this ScoreAncestryDistributionGwas.  # noqa: E501
        :type: dict(str, int)
        """
    ...
    @property
    def count(self):
        """Gets the count of this ScoreAncestryDistributionGwas.  # noqa: E501

        Total number of individuals from this stage.  # noqa: E501

        :return: The count of this ScoreAncestryDistributionGwas.  # noqa: E501
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """Sets the count of this ScoreAncestryDistributionGwas.

        Total number of individuals from this stage.  # noqa: E501

        :param count: The count of this ScoreAncestryDistributionGwas.  # noqa: E501
        :type: int
        """
    ...
    @property
    def multi(self):
        """Gets the multi of this ScoreAncestryDistributionGwas.  # noqa: E501

        Breakdown of the Multi-ancestry (MAO or MAE) distribution. Only available if there is a Multi-ancestry entry in the distribution.  # noqa: E501

        :return: The multi of this ScoreAncestryDistributionGwas.  # noqa: E501
        :rtype: list[str]
        """
        return self._multi
    ...
    def multi(self, multi):
        """Sets the multi of this ScoreAncestryDistributionGwas.

        Breakdown of the Multi-ancestry (MAO or MAE) distribution. Only available if there is a Multi-ancestry entry in the distribution.  # noqa: E501

        :param multi: The multi of this ScoreAncestryDistributionGwas.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ScoreAncestryDistributionGwas, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ScoreAncestryDistributionGwas):
            return False
