...
import six
from pgs_catalog_client.models.efo_trait_ontology import EFOTraitOntology  # noqa: F401,E501

class EFOTraitOntologyChild(EFOTraitOntology):
    ...
    """
    swagger_types = {
        'child_traits': 'list[EFOTraitOntology]'
    }
    if hasattr(EFOTraitOntology, "swagger_types"):
        swagger_types.update(EFOTraitOntology.swagger_types)

    attribute_map = {
        'child_traits': 'child_traits'
    }
    if hasattr(EFOTraitOntology, "attribute_map"):
        attribute_map.update(EFOTraitOntology.attribute_map)

    def __init__(self, child_traits=None, *args, **kwargs):  # noqa: E501
        """EFOTraitOntologyChild - a model defined in Swagger"""  # noqa: E501
        self._child_traits = None
        self.discriminator = None
        if child_traits is not None:
            self.child_traits = child_traits
        EFOTraitOntology.__init__(self, *args, **kwargs)

    @property
    def child_traits(self):
        """Gets the child_traits of this EFOTraitOntologyChild.  # noqa: E501

        List of child traits with Polygenic Score associations.  # noqa: E501

        :return: The child_traits of this EFOTraitOntologyChild.  # noqa: E501
        :rtype: list[EFOTraitOntology]
        """
        return self._child_traits

    @child_traits.setter
    def child_traits(self, child_traits):
        """Sets the child_traits of this EFOTraitOntologyChild.

        List of child traits with Polygenic Score associations.  # noqa: E501

        :param child_traits: The child_traits of this EFOTraitOntologyChild.  # noqa: E501
        :type: list[EFOTraitOntology]
        """

        self._child_traits = child_traits
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EFOTraitOntologyChild, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EFOTraitOntologyChild):
            return False
