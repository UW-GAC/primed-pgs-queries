...
class EFOTrait(object):
    ...
    def __init__(self, id=None, label=None, description=None, url=None):  # noqa: E501
        """EFOTrait - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._label = None
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this EFOTrait.

        A trait identifier that links to an Ontology (e.g. EFO), and NHGRI-EBI GWAS catalog.  # noqa: E501

        :param id: The id of this EFOTrait.  # noqa: E501
        :type: str
        """
    ...
    @property
    def label(self):
        """Gets the label of this EFOTrait.  # noqa: E501

        Trait label/name  # noqa: E501

        :return: The label of this EFOTrait.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this EFOTrait.

        Trait label/name  # noqa: E501

        :param label: The label of this EFOTrait.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this EFOTrait.  # noqa: E501

        Detailed description of the trait from EFO.  # noqa: E501

        :return: The description of this EFOTrait.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this EFOTrait.

        Detailed description of the trait from EFO.  # noqa: E501

        :param description: The description of this EFOTrait.  # noqa: E501
        :type: str
        """
    ...
    @property
    def url(self):
        """Gets the url of this EFOTrait.  # noqa: E501

        External link to the EFO entry  # noqa: E501

        :return: The url of this EFOTrait.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this EFOTrait.

        External link to the EFO entry  # noqa: E501

        :param url: The url of this EFOTrait.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EFOTrait):
            return False
