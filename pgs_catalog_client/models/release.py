...
class Release(object):
    ...
    swagger_types = {
        ...
        'notes': 'str',
        'released_score_ids': 'list[str]',
        'released_publication_ids': 'list[str]',
        'released_performance_ids': 'list[str]'
    }
    ...
    def __init__(self, _date=None, score_count=None, performance_count=None, publication_count=None, notes=None, released_score_ids=None, released_publication_ids=None, released_performance_ids=None):  # noqa: E501
        """Release - a model defined in Swagger"""  # noqa: E501
        self.__date = None
        self._score_count = None
        self._performance_count = None
        self._publication_count = None
        self._notes = None
        self._released_score_ids = None
        self._released_publication_ids = None
        self._released_performance_ids = None
        ...
        if notes is not None:
            self.notes = notes
        if released_score_ids is not None:
            self.released_score_ids = released_score_ids
        if released_publication_ids is not None:
            self.released_publication_ids = released_publication_ids
        if released_performance_ids is not None:
            self.released_performance_ids = released_performance_ids

    @property
    def _date(self):
        """Gets the _date of this Release.  # noqa: E501

        Date of PGS release (format YYYY-MM-DD)  # noqa: E501

        :return: The _date of this Release.  # noqa: E501
        :rtype: date
        """
        return self.__date
    ...
    def _date(self, _date):
        """Sets the _date of this Release.

        Date of PGS release (format YYYY-MM-DD)  # noqa: E501

        :param _date: The _date of this Release.  # noqa: E501
        :type: date
        """
    ...
    def score_count(self):
        """Gets the score_count of this Release.  # noqa: E501

        Count of new Polygenic Scores  # noqa: E501

        :return: The score_count of this Release.  # noqa: E501
        :rtype: int
        """
        return self._score_count

    @score_count.setter
    def score_count(self, score_count):
        """Sets the score_count of this Release.

        Count of new Polygenic Scores  # noqa: E501

        :param score_count: The score_count of this Release.  # noqa: E501
        :type: int
        """
    ...
    def performance_count(self):
        """Gets the performance_count of this Release.  # noqa: E501

        Count of new PGS Performance Metrics  # noqa: E501

        :return: The performance_count of this Release.  # noqa: E501
        :rtype: int
        """
        return self._performance_count

    @performance_count.setter
    def performance_count(self, performance_count):
        """Sets the performance_count of this Release.

        Count of new PGS Performance Metrics  # noqa: E501

        :param performance_count: The performance_count of this Release.  # noqa: E501
        :type: int
        """

        self._performance_count = performance_count

    @property
    def publication_count(self):
        """Gets the publication_count of this Release.  # noqa: E501

        Count of new PGS Publications  # noqa: E501

        :return: The publication_count of this Release.  # noqa: E501
        :rtype: int
        """
        return self._publication_count

    @publication_count.setter
    def publication_count(self, publication_count):
        """Sets the publication_count of this Release.

        Count of new PGS Publications  # noqa: E501

        :param publication_count: The publication_count of this Release.  # noqa: E501
        :type: int
        """
    ...
    @property
    def notes(self):
        """Gets the notes of this Release.  # noqa: E501


        :return: The notes of this Release.  # noqa: E501
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this Release.


        :param notes: The notes of this Release.  # noqa: E501
        :type: str
        """
    ...
    def released_score_ids(self):
        """Gets the released_score_ids of this Release.  # noqa: E501

        List of new Polygenic Score IDs  # noqa: E501

        :return: The released_score_ids of this Release.  # noqa: E501
        :rtype: list[str]
        """
        return self._released_score_ids

    @released_score_ids.setter
    def released_score_ids(self, released_score_ids):
        """Sets the released_score_ids of this Release.

        List of new Polygenic Score IDs  # noqa: E501

        :param released_score_ids: The released_score_ids of this Release.  # noqa: E501
        :type: list[str]
        """

        self._released_score_ids = released_score_ids

    @property
    def released_publication_ids(self):
        """Gets the released_publication_ids of this Release.  # noqa: E501

        List of new PGS Publication IDs  # noqa: E501

        :return: The released_publication_ids of this Release.  # noqa: E501
        :rtype: list[str]
        """
        return self._released_publication_ids

    @released_publication_ids.setter
    def released_publication_ids(self, released_publication_ids):
        """Sets the released_publication_ids of this Release.

        List of new PGS Publication IDs  # noqa: E501

        :param released_publication_ids: The released_publication_ids of this Release.  # noqa: E501
        :type: list[str]
        """

        self._released_publication_ids = released_publication_ids

    @property
    def released_performance_ids(self):
        """Gets the released_performance_ids of this Release.  # noqa: E501

        List of new PGS Performance Metric IDs  # noqa: E501

        :return: The released_performance_ids of this Release.  # noqa: E501
        :rtype: list[str]
        """
        return self._released_performance_ids

    @released_performance_ids.setter
    def released_performance_ids(self, released_performance_ids):
        """Sets the released_performance_ids of this Release.

        List of new PGS Performance Metric IDs  # noqa: E501

        :param released_performance_ids: The released_performance_ids of this Release.  # noqa: E501
        :type: list[str]
        """

        self._released_performance_ids = released_performance_ids
