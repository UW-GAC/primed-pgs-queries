...
class TraitCategory(object):
    ...
    def __init__(self, label=None, efotraits=None):  # noqa: E501
        """TraitCategory - a model defined in Swagger"""  # noqa: E501
        self._label = None
        self._efotraits = None
        self.discriminator = None
        if label is not None:
            self.label = label
        if efotraits is not None:
            self.efotraits = efotraits

    @property
    def label(self):
        """Gets the label of this TraitCategory.  # noqa: E501

        Trait category name  # noqa: E501

        :return: The label of this TraitCategory.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this TraitCategory.

        Trait category name  # noqa: E501

        :param label: The label of this TraitCategory.  # noqa: E501
        :type: str
        """
    ...
    @property
    def efotraits(self):
        """Gets the efotraits of this TraitCategory.  # noqa: E501


        :return: The efotraits of this TraitCategory.  # noqa: E501
        :rtype: EFOTrait
        """
        return self._efotraits

    @efotraits.setter
    def efotraits(self, efotraits):
        """Sets the efotraits of this TraitCategory.


        :param efotraits: The efotraits of this TraitCategory.  # noqa: E501
        :type: EFOTrait
        """

        self._efotraits = efotraits
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TraitCategory, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TraitCategory):
            return False
