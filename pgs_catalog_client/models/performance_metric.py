...
class PerformanceMetric(object):
    ...
    swagger_types = {
        'id': 'str',
        'associated_pgs_id': 'str',
        'phenotyping_reported': 'str',
        'publication': 'Publication',
        'sampleset': 'SampleSet',
        'performance_metrics': 'PerformanceMetricPerformanceMetrics',
        'covariates': 'str',
        'performance_comments': 'str'
    }

    attribute_map = {
        'id': 'id',
        'associated_pgs_id': 'associated_pgs_id',
    ...
    def __init__(self, id=None, associated_pgs_id=None, phenotyping_reported=None, publication=None, sampleset=None, performance_metrics=None, covariates=None, performance_comments=None):  # noqa: E501
        """PerformanceMetric - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._associated_pgs_id = None
        self._phenotyping_reported = None
        self._publication = None
        self._sampleset = None
        self._performance_metrics = None
        self._covariates = None
        self._performance_comments = None
        self.discriminator = None
        if id is not None:
            self.id = id
        if associated_pgs_id is not None:
            self.associated_pgs_id = associated_pgs_id
        if phenotyping_reported is not None:
        ...
        if performance_comments is not None:
    ...
    def id(self):
        ...
        PGS Performance Metric identifier  # noqa: E501
    ...
    def associated_pgs_id(self):
        """Gets the associated_pgs_id of this PerformanceMetric.  # noqa: E501

        Associated PGS ID  # noqa: E501

        :return: The associated_pgs_id of this PerformanceMetric.  # noqa: E501
        :rtype: str
        """
        return self._associated_pgs_id

    @associated_pgs_id.setter
    def associated_pgs_id(self, associated_pgs_id):
        """Sets the associated_pgs_id of this PerformanceMetric.

        Associated PGS ID  # noqa: E501

        :param associated_pgs_id: The associated_pgs_id of this PerformanceMetric.  # noqa: E501
        :type: str
        """

        self._associated_pgs_id = associated_pgs_id

    @property
    def phenotyping_reported(self):
        """Gets the phenotyping_reported of this PerformanceMetric.  # noqa: E501


        :return: The phenotyping_reported of this PerformanceMetric.  # noqa: E501
        :rtype: str
        """
        return self._phenotyping_reported

    @phenotyping_reported.setter
    def phenotyping_reported(self, phenotyping_reported):
        """Sets the phenotyping_reported of this PerformanceMetric.


        :param phenotyping_reported: The phenotyping_reported of this PerformanceMetric.  # noqa: E501
        :type: str
        """

        self._phenotyping_reported = phenotyping_reported

    @property
    def publication(self):
        """Gets the publication of this PerformanceMetric.  # noqa: E501


        :return: The publication of this PerformanceMetric.  # noqa: E501
        :rtype: Publication
        """
    ...
    def publication(self, publication):
        """Sets the publication of this PerformanceMetric.


        :param publication: The publication of this PerformanceMetric.  # noqa: E501
        :type: Publication
        """
    ...
    @property
    def sampleset(self):
        """Gets the sampleset of this PerformanceMetric.  # noqa: E501


        :return: The sampleset of this PerformanceMetric.  # noqa: E501
        :rtype: SampleSet
        """
    ...
    def sampleset(self, sampleset):
        """Sets the sampleset of this PerformanceMetric.


        :param sampleset: The sampleset of this PerformanceMetric.  # noqa: E501
        :type: SampleSet
        """
    ...
    def performance_metrics(self):
        """Gets the performance_metrics of this PerformanceMetric.  # noqa: E501


        :return: The performance_metrics of this PerformanceMetric.  # noqa: E501
        :rtype: PerformanceMetricPerformanceMetrics
        """
        return self._performance_metrics

    @performance_metrics.setter
    def performance_metrics(self, performance_metrics):
        """Sets the performance_metrics of this PerformanceMetric.


        :param performance_metrics: The performance_metrics of this PerformanceMetric.  # noqa: E501
        :type: PerformanceMetricPerformanceMetrics
        """
    ...
    @property
    def covariates(self):
        """Gets the covariates of this PerformanceMetric.  # noqa: E501

        Comma-separated list of covariates used in the prediction model to evaluate the PGS.  # noqa: E501

        :return: The covariates of this PerformanceMetric.  # noqa: E501
        :rtype: str
        """
    ...
    def covariates(self, covariates):
        """Sets the covariates of this PerformanceMetric.

        Comma-separated list of covariates used in the prediction model to evaluate the PGS.  # noqa: E501

        :param covariates: The covariates of this PerformanceMetric.  # noqa: E501
        :type: str
        """
    ...
    @property
    def performance_comments(self):
        """Gets the performance_comments of this PerformanceMetric.  # noqa: E501

        Any other information relevant to the understanding of the performance metrics.  # noqa: E501

        :return: The performance_comments of this PerformanceMetric.  # noqa: E501
        :rtype: str
        """
        return self._performance_comments

    @performance_comments.setter
    def performance_comments(self, performance_comments):
        """Sets the performance_comments of this PerformanceMetric.

        Any other information relevant to the understanding of the performance metrics.  # noqa: E501

        :param performance_comments: The performance_comments of this PerformanceMetric.  # noqa: E501
        :type: str
        """

        self._performance_comments = performance_comments
