...
class EFOTraitOntology(object):
    ...
    swagger_types = {
        ...
        'trait_synonyms': 'list[str]',
        'trait_mapped_terms': 'list[str]',
        'associated_pgs_ids': 'list[str]',
        'child_associated_pgs_ids': 'list[str]'
    }
    ...
    attribute_map = {
        ...
        'child_associated_pgs_ids': 'child_associated_pgs_ids'
    }

    def __init__(self, id=None, label=None, description=None, url=None, trait_categories=None, trait_synonyms=None, trait_mapped_terms=None, associated_pgs_ids=None, child_associated_pgs_ids=None):  # noqa: E501
        """EFOTraitOntology - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._label = None
        self._description = None
        self._url = None
        self._trait_categories = None
        self._trait_synonyms = None
        self._trait_mapped_terms = None
        self._associated_pgs_ids = None
        self._child_associated_pgs_ids = None
        ...
        if trait_synonyms is not None:
            self.trait_synonyms = trait_synonyms
        if trait_mapped_terms is not None:
            self.trait_mapped_terms = trait_mapped_terms
        if associated_pgs_ids is not None:
            self.associated_pgs_ids = associated_pgs_ids
        if child_associated_pgs_ids is not None:
            self.child_associated_pgs_ids = child_associated_pgs_ids

    @property
    def id(self):
        """Gets the id of this EFOTraitOntology.  # noqa: E501

        A trait identifier that links to an Ontology (e.g. EFO), and NHGRI-EBI GWAS catalog.  # noqa: E501

        :return: The id of this EFOTraitOntology.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this EFOTraitOntology.

        A trait identifier that links to an Ontology (e.g. EFO), and NHGRI-EBI GWAS catalog.  # noqa: E501

        :param id: The id of this EFOTraitOntology.  # noqa: E501
        :type: str
        """
    ...
    @property
    def label(self):
        """Gets the label of this EFOTraitOntology.  # noqa: E501

        Trait label/name  # noqa: E501

        :return: The label of this EFOTraitOntology.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this EFOTraitOntology.

        Trait label/name  # noqa: E501

        :param label: The label of this EFOTraitOntology.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this EFOTraitOntology.  # noqa: E501

        Detailed description of the trait from EFO.  # noqa: E501

        :return: The description of this EFOTraitOntology.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this EFOTraitOntology.

        Detailed description of the trait from EFO.  # noqa: E501

        :param description: The description of this EFOTraitOntology.  # noqa: E501
        :type: str
        """
    ...
    @property
    def url(self):
        """Gets the url of this EFOTraitOntology.  # noqa: E501

        External link to the EFO entry  # noqa: E501

        :return: The url of this EFOTraitOntology.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this EFOTraitOntology.

        External link to the EFO entry  # noqa: E501

        :param url: The url of this EFOTraitOntology.  # noqa: E501
        :type: str
        """
    ...
    @property
    def trait_categories(self):
        """Gets the trait_categories of this EFOTraitOntology.  # noqa: E501

        List of trait categories associated with the trait  # noqa: E501

        :return: The trait_categories of this EFOTraitOntology.  # noqa: E501
        :rtype: list[str]
        """
        return self._trait_categories

    @trait_categories.setter
    def trait_categories(self, trait_categories):
        """Sets the trait_categories of this EFOTraitOntology.

        List of trait categories associated with the trait  # noqa: E501

        :param trait_categories: The trait_categories of this EFOTraitOntology.  # noqa: E501
        :type: list[str]
        """

        self._trait_categories = trait_categories

    @property
    def trait_synonyms(self):
        """Gets the trait_synonyms of this EFOTraitOntology.  # noqa: E501

        List of associated trait synonyms  # noqa: E501

        :return: The trait_synonyms of this EFOTraitOntology.  # noqa: E501
        :rtype: list[str]
        """
        return self._trait_synonyms

    @trait_synonyms.setter
    def trait_synonyms(self, trait_synonyms):
        """Sets the trait_synonyms of this EFOTraitOntology.

        List of associated trait synonyms  # noqa: E501

        :param trait_synonyms: The trait_synonyms of this EFOTraitOntology.  # noqa: E501
        :type: list[str]
        """

        self._trait_synonyms = trait_synonyms

    @property
    def trait_mapped_terms(self):
        """Gets the trait_mapped_terms of this EFOTraitOntology.  # noqa: E501

        List of associated external references/IDs  # noqa: E501

        :return: The trait_mapped_terms of this EFOTraitOntology.  # noqa: E501
        :rtype: list[str]
        """
        return self._trait_mapped_terms

    @trait_mapped_terms.setter
    def trait_mapped_terms(self, trait_mapped_terms):
        """Sets the trait_mapped_terms of this EFOTraitOntology.

        List of associated external references/IDs  # noqa: E501

        :param trait_mapped_terms: The trait_mapped_terms of this EFOTraitOntology.  # noqa: E501
        :type: list[str]
        """

        self._trait_mapped_terms = trait_mapped_terms

    @property
    def associated_pgs_ids(self):
        """Gets the associated_pgs_ids of this EFOTraitOntology.  # noqa: E501

        List of associated Polygenic Score IDs  # noqa: E501

        :return: The associated_pgs_ids of this EFOTraitOntology.  # noqa: E501
        :rtype: list[str]
        """
        return self._associated_pgs_ids

    @associated_pgs_ids.setter
    def associated_pgs_ids(self, associated_pgs_ids):
        """Sets the associated_pgs_ids of this EFOTraitOntology.

        List of associated Polygenic Score IDs  # noqa: E501

        :param associated_pgs_ids: The associated_pgs_ids of this EFOTraitOntology.  # noqa: E501
        :type: list[str]
        """

        self._associated_pgs_ids = associated_pgs_ids

    @property
    def child_associated_pgs_ids(self):
        """Gets the child_associated_pgs_ids of this EFOTraitOntology.  # noqa: E501

        List of Polygenic Score IDs associated with the children ontology term(s)  # noqa: E501

        :return: The child_associated_pgs_ids of this EFOTraitOntology.  # noqa: E501
        :rtype: list[str]
        """
        return self._child_associated_pgs_ids

    @child_associated_pgs_ids.setter
    def child_associated_pgs_ids(self, child_associated_pgs_ids):
        """Sets the child_associated_pgs_ids of this EFOTraitOntology.

        List of Polygenic Score IDs associated with the children ontology term(s)  # noqa: E501

        :param child_associated_pgs_ids: The child_associated_pgs_ids of this EFOTraitOntology.  # noqa: E501
        :type: list[str]
        """

        self._child_associated_pgs_ids = child_associated_pgs_ids
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EFOTraitOntology, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EFOTraitOntology):
            return False
