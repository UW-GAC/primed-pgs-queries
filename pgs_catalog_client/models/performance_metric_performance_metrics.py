...
class PerformanceMetricPerformanceMetrics(object):
    ...
    """
    swagger_types = {
        'effect_sizes': 'list[Metric]',
        'class_acc': 'list[Metric]',
        'othermetrics': 'list[Metric]'
    }
    ...
    def __init__(self, effect_sizes=None, class_acc=None, othermetrics=None):  # noqa: E501
        """PerformanceMetricPerformanceMetrics - a model defined in Swagger"""  # noqa: E501
        ...
        if othermetrics is not None:
            self.othermetrics = othermetrics

    @property
    def effect_sizes(self):
        """Gets the effect_sizes of this PerformanceMetricPerformanceMetrics.  # noqa: E501

        List of Effect Size data  # noqa: E501

        :return: The effect_sizes of this PerformanceMetricPerformanceMetrics.  # noqa: E501
        :rtype: list[Metric]
        """
        return self._effect_sizes

    @effect_sizes.setter
    def effect_sizes(self, effect_sizes):
        """Sets the effect_sizes of this PerformanceMetricPerformanceMetrics.

        List of Effect Size data  # noqa: E501

        :param effect_sizes: The effect_sizes of this PerformanceMetricPerformanceMetrics.  # noqa: E501
        :type: list[Metric]
        """

        self._effect_sizes = effect_sizes

    @property
    def class_acc(self):
        """Gets the class_acc of this PerformanceMetricPerformanceMetrics.  # noqa: E501

        List of Classification Metric data  # noqa: E501

        :return: The class_acc of this PerformanceMetricPerformanceMetrics.  # noqa: E501
        :rtype: list[Metric]
        """
        return self._class_acc

    @class_acc.setter
    def class_acc(self, class_acc):
        """Sets the class_acc of this PerformanceMetricPerformanceMetrics.

        List of Classification Metric data  # noqa: E501

        :param class_acc: The class_acc of this PerformanceMetricPerformanceMetrics.  # noqa: E501
        :type: list[Metric]
        """

        self._class_acc = class_acc

    @property
    def othermetrics(self):
        """Gets the othermetrics of this PerformanceMetricPerformanceMetrics.  # noqa: E501

        Metrics that do not fit into the Effect Size or Classification Metric categories. e.g. R² (proportion of the variance explained), or reclassification metrics.  # noqa: E501

        :return: The othermetrics of this PerformanceMetricPerformanceMetrics.  # noqa: E501
        :rtype: list[Metric]
        """
        return self._othermetrics

    @othermetrics.setter
    def othermetrics(self, othermetrics):
        """Sets the othermetrics of this PerformanceMetricPerformanceMetrics.

        Metrics that do not fit into the Effect Size or Classification Metric categories. e.g. R² (proportion of the variance explained), or reclassification metrics.  # noqa: E501

        :param othermetrics: The othermetrics of this PerformanceMetricPerformanceMetrics.  # noqa: E501
        :type: list[Metric]
        """

        self._othermetrics = othermetrics
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PerformanceMetricPerformanceMetrics, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PerformanceMetricPerformanceMetrics):
            return False
