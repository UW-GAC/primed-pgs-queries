...
import six
from pgs_catalog_client.models.publication import Publication  # noqa: F401,E501

class PublicationExtended(Publication):
    ...
    swagger_types = {
        'date_release': 'date',
        'authors': 'str',
        'associated_pgs_ids': 'CohortExtendedAssociatedPgsIds'
    }
    if hasattr(Publication, "swagger_types"):
        swagger_types.update(Publication.swagger_types)
    ...
    if hasattr(Publication, "attribute_map"):
        attribute_map.update(Publication.attribute_map)

    def __init__(self, date_release=None, authors=None, associated_pgs_ids=None, *args, **kwargs):  # noqa: E501
        """PublicationExtended - a model defined in Swagger"""  # noqa: E501
        ...
        Publication.__init__(self, *args, **kwargs)

    @property
    def date_release(self):
        """Gets the date_release of this PublicationExtended.  # noqa: E501

        Release date in PGS Catalog (format YYYY-MM-DD)  # noqa: E501

        :return: The date_release of this PublicationExtended.  # noqa: E501
        :rtype: date
        """
    ...
    def date_release(self, date_release):
        """Sets the date_release of this PublicationExtended.

        Release date in PGS Catalog (format YYYY-MM-DD)  # noqa: E501

        :param date_release: The date_release of this PublicationExtended.  # noqa: E501
        :type: date
        """
    ...
    @property
    def authors(self):
        """Gets the authors of this PublicationExtended.  # noqa: E501

        Concatenated list of all the publication authors  # noqa: E501

        :return: The authors of this PublicationExtended.  # noqa: E501
        :rtype: str
        """
    ...
    def authors(self, authors):
        """Sets the authors of this PublicationExtended.

        Concatenated list of all the publication authors  # noqa: E501

        :param authors: The authors of this PublicationExtended.  # noqa: E501
        :type: str
        """
    ...
    def associated_pgs_ids(self):
        """Gets the associated_pgs_ids of this PublicationExtended.  # noqa: E501


        :return: The associated_pgs_ids of this PublicationExtended.  # noqa: E501
        :rtype: CohortExtendedAssociatedPgsIds
        """
        return self._associated_pgs_ids

    @associated_pgs_ids.setter
    def associated_pgs_ids(self, associated_pgs_ids):
        """Sets the associated_pgs_ids of this PublicationExtended.


        :param associated_pgs_ids: The associated_pgs_ids of this PublicationExtended.  # noqa: E501
        :type: CohortExtendedAssociatedPgsIds
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PublicationExtended, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PublicationExtended):
            return False
