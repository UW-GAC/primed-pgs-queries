...
class TraitEndpointsApi(object):
    ...
    def get_all_trait_categories(self, **kwargs):  # noqa: E501
        """get_all_trait_categories  # noqa: E501

        Retrieve all higher-level Trait Categories in the Catalog, including for each of them:   * Trait category name   * List of all PGS Traits (EFO Ontology Terms) associated with the category  Trait Category to Trait mappings are retrieved from the <a class=\"link external-link\" href=\"https://www.ebi.ac.uk/gwas/rest/docs/api#custom-parent\" target=\"_blank\">NHGRI-EBI GWAS Catalog</a>, structuring the traits (ontology terms) into higher-level groups..  Example of request: ``` https://www.pgscatalog.org/rest/trait_category/all ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_trait_categories(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_all_trait_categories_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_all_trait_categories_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_all_trait_categories_with_http_info(self, **kwargs):  # noqa: E501
        """get_all_trait_categories  # noqa: E501

        Retrieve all higher-level Trait Categories in the Catalog, including for each of them:   * Trait category name   * List of all PGS Traits (EFO Ontology Terms) associated with the category  Trait Category to Trait mappings are retrieved from the <a class=\"link external-link\" href=\"https://www.ebi.ac.uk/gwas/rest/docs/api#custom-parent\" target=\"_blank\">NHGRI-EBI GWAS Catalog</a>, structuring the traits (ontology terms) into higher-level groups..  Example of request: ``` https://www.pgscatalog.org/rest/trait_category/all ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_trait_categories_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_all_trait_categories" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_all_traits(self, **kwargs):  # noqa: E501
        """get_all_traits  # noqa: E501

        Retrieve all the Traits, including for each of them:   * Ontology ID, trait label, description and URL   * Trait categories   * Synonyms and external mapped terms   * Associated Polygenic Score(s)   * Associated Polygenic Score(s) with child trait(s) - **<span class=\"colour_2\">[</span>** only when the parameter **include_child_associated_pgs_ids** is set to **1** **<span class=\"colour_2\">]</span>**  This endpoint can be used to retrieve trait-PGS mappings for any trait in the database (including parent traits from the ontology that aren’t included in the `/rest/trait/all` endpoint).  Example of request: ``` https://www.pgscatalog.org/rest/trait/all ``` --- ###### **Filtering**  You can choose to filter the results of this endpoint to a specified list of traits by providing a list of ontology IDs in one of two ways: 1. A comma-seperated list of ontology IDs in the request URL (this will not work for larger queries), e.g.: ``` https://www.pgscatalog.org/rest/trait/all?filter_ids=EFO_0000305,EFO_0001645 ``` 2. A json-formatted list of IDs, e.g.: `{ \"filter_ids\" : [\"EFO_0000305\",\"EFO_0001645\"] }`. Example with curl: ``` curl -X GET 'https://www.pgscatalog.org/rest/trait/all' -H 'Content-type:application/json' -d '{ \"filter_ids\" : [\"EFO_0000305\", \"EFO_0001645\"] }' ``` The 2 parameters can be used in JSON: `{ \"filter_ids\" : [\"EFO_0000305\",\"EFO_0001645\"], \"include_child_associated_pgs_ids\" : 1 }`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_traits(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str filter_ids: Comma-separated list of ontology trait IDs or JSON object with an array of ontology trait IDs
        :param int include_child_associated_pgs_ids: Flag to include or not the list of PGS IDs associated with children traits
        :param int include_parents: Flag to include or not the parents of the traits associated with PGS
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_traits_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_all_traits_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_all_traits_with_http_info(self, **kwargs):  # noqa: E501
        """get_all_traits  # noqa: E501

        Retrieve all the Traits, including for each of them:   * Ontology ID, trait label, description and URL   * Trait categories   * Synonyms and external mapped terms   * Associated Polygenic Score(s)   * Associated Polygenic Score(s) with child trait(s) - **<span class=\"colour_2\">[</span>** only when the parameter **include_child_associated_pgs_ids** is set to **1** **<span class=\"colour_2\">]</span>**  This endpoint can be used to retrieve trait-PGS mappings for any trait in the database (including parent traits from the ontology that aren’t included in the `/rest/trait/all` endpoint).  Example of request: ``` https://www.pgscatalog.org/rest/trait/all ``` --- ###### **Filtering**  You can choose to filter the results of this endpoint to a specified list of traits by providing a list of ontology IDs in one of two ways: 1. A comma-seperated list of ontology IDs in the request URL (this will not work for larger queries), e.g.: ``` https://www.pgscatalog.org/rest/trait/all?filter_ids=EFO_0000305,EFO_0001645 ``` 2. A json-formatted list of IDs, e.g.: `{ \"filter_ids\" : [\"EFO_0000305\",\"EFO_0001645\"] }`. Example with curl: ``` curl -X GET 'https://www.pgscatalog.org/rest/trait/all' -H 'Content-type:application/json' -d '{ \"filter_ids\" : [\"EFO_0000305\", \"EFO_0001645\"] }' ``` The 2 parameters can be used in JSON: `{ \"filter_ids\" : [\"EFO_0000305\",\"EFO_0001645\"], \"include_child_associated_pgs_ids\" : 1 }`   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_traits_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['filter_ids', 'include_child_associated_pgs_ids', 'include_parents']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'include_child_associated_pgs_ids' in params:
            query_params.append(('include_child_associated_pgs_ids', params['include_child_associated_pgs_ids']))  # noqa: E501
    ...
    def get_trait(self, trait_id, **kwargs):  # noqa: E501
        """get_trait  # noqa: E501

        Retrieve a Trait, including:   * Ontology ID, trait label, description and URL   * Trait categories   * Synonyms and external mapped terms   * Associated Polygenic Score(s)   * Associated Polygenic Score(s) with child trait(s)   * Child traits (when the parameter *include_children* is set to 1)  This endpoint can be used to retrieve trait-PGS mappings for any trait in the database (including parent terms from the ontology that aren’t included in the `/rest/trait/all` endpoint).  Example of request: ``` https://www.pgscatalog.org/rest/trait/EFO_0000305 ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param str trait_id: Ontology ID (e.g. from EFO, HP or MONDO) with the format \"EFO_XXXX\" (required)
        :param int include_children: Flag to include or not the children of the searched trait (defaut: 1)
        :return: EFOTraitOntologyChild
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            ...
            (data) = self.get_trait_with_http_info(trait_id, **kwargs)  # noqa: E501
            return data

    def get_trait_with_http_info(self, trait_id, **kwargs):  # noqa: E501
        """get_trait  # noqa: E501
        ...
        all_params = ['trait_id', 'include_children']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('trait_id' not in params or
            ...
            raise ValueError("Missing the required parameter `trait_id` when calling `get_trait`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'trait_id' in params:
            path_params['trait_id'] = params['trait_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='EFOTraitOntologyChild',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def search_trait(self, term, **kwargs):  # noqa: E501
        """search_trait  # noqa: E501

        Search for Traits based on terms present in the ID, label, description, synonyms, categories, or external mapped terms.<br /> The search term and filters for exact matching and child-term relationships can be included directly in the request URL, e.g.: ``` https://www.pgscatalog.org/rest/trait/search?term=Alzheimer ``` This returns a list of Traits matching the search term (and by default their child terms from the ontology), including for each of them:   * Ontology ID, trait label, description and URL   * Trait categories   * Synonyms and external mapped terms   * Associated Polygenic Score(s)   * Associated Polygenic Score(s) with child trait(s)  This endpoint searches all traits in the database, including parent terms from the ontology that aren’t included in the `/rest/trait/all` endpoint.<br />   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_trait(term, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str term: Trait ID, trait name, trait category, trait synonym or external mapped terms/IDs (required)
        :param int exact: Flag to search only the exact term or not (defaut: 0)
        :param int include_children: Flag to include or not the children of the searched trait (defaut: 1)
        :return: InlineResponse2008
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.search_trait_with_http_info(term, **kwargs)  # noqa: E501
        else:
            (data) = self.search_trait_with_http_info(term, **kwargs)  # noqa: E501
            return data

    def search_trait_with_http_info(self, term, **kwargs):  # noqa: E501
        """search_trait  # noqa: E501

        Search for Traits based on terms present in the ID, label, description, synonyms, categories, or external mapped terms.<br /> The search term and filters for exact matching and child-term relationships can be included directly in the request URL, e.g.: ``` https://www.pgscatalog.org/rest/trait/search?term=Alzheimer ``` This returns a list of Traits matching the search term (and by default their child terms from the ontology), including for each of them:   * Ontology ID, trait label, description and URL   * Trait categories   * Synonyms and external mapped terms   * Associated Polygenic Score(s)   * Associated Polygenic Score(s) with child trait(s)  This endpoint searches all traits in the database, including parent terms from the ontology that aren’t included in the `/rest/trait/all` endpoint.<br />   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_trait_with_http_info(term, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['term', 'exact', 'include_children']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('term' not in params or
                params['term'] is None):
            raise ValueError("Missing the required parameter `term` when calling `search_trait`")  # noqa: E501
