...
class SampleEndpointsApi(object):
    ...
    def get_all_cohorts(self, **kwargs):  # noqa: E501
        """get_all_cohorts  # noqa: E501

        Retrieve all Cohorts, including for each of them:   * Cohort full name   * Associated Polygenic Scores(s), with the distinction between associations with the Polygenic Score at the development phase or at the evaluation phase  Example of request: ``` https://www.pgscatalog.org/rest/cohort/all ``` --- ###### **Filtering**  You can choose to filter the results of this endpoint to a specified list of cohorts by providing a list of cohort symbols in one of two ways: 1. A comma-seperated list of cohort symbols in the request URL (this will not work for larger queries), e.g.: ``` https://www.pgscatalog.org/rest/cohort/all?filter_ids=ABCFS,ESTHER ``` 2. A json-formatted list of IDs, e.g.: `{ \"filter_ids\" : [\"ABCFS\",\"ESTHER\"] }`. Example with curl: ``` curl -X GET 'https://www.pgscatalog.org/rest/cohort/all' -H 'Content-type:application/json' -d '{ \"filter_ids\" : [\"ABCFS\", \"ESTHER\"] }' ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_cohorts(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str filter_ids: Comma-separated list of cohort symbols or JSON object with an array of cohort symbols
        ...
        if kwargs.get('async_req'):
            return self.get_all_cohorts_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_all_cohorts_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_all_cohorts_with_http_info(self, **kwargs):  # noqa: E501
        """get_all_cohorts  # noqa: E501

        Retrieve all Cohorts, including for each of them:   * Cohort full name   * Associated Polygenic Scores(s), with the distinction between associations with the Polygenic Score at the development phase or at the evaluation phase  Example of request: ``` https://www.pgscatalog.org/rest/cohort/all ``` --- ###### **Filtering**  You can choose to filter the results of this endpoint to a specified list of cohorts by providing a list of cohort symbols in one of two ways: 1. A comma-seperated list of cohort symbols in the request URL (this will not work for larger queries), e.g.: ``` https://www.pgscatalog.org/rest/cohort/all?filter_ids=ABCFS,ESTHER ``` 2. A json-formatted list of IDs, e.g.: `{ \"filter_ids\" : [\"ABCFS\",\"ESTHER\"] }`. Example with curl: ``` curl -X GET 'https://www.pgscatalog.org/rest/cohort/all' -H 'Content-type:application/json' -d '{ \"filter_ids\" : [\"ABCFS\", \"ESTHER\"] }' ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_cohorts_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def get_all_sample_sets(self, **kwargs):  # noqa: E501
        """get_all_sample_sets  # noqa: E501

        Retrieve one Sample Set (group of samples used on a Performance Metric), including for each of them:   * List of samples     * Ancestry data     * Corresponding cohort(s)  Example of request: ``` https://www.pgscatalog.org/rest/sample_set/all ``` --- ###### **Filtering**  You can choose to filter the results of this endpoint to a specified list of sample sets by providing a list of PGS Sample Set IDs (PSS) in one of two ways: 1. A comma-seperated list of PSS IDs in the request URL (this will not work for larger queries), e.g.: ``` https://www.pgscatalog.org/rest/sample_set/all?filter_ids=PSS000018,PSS000070 ``` 2. A json-formatted list of IDs, e.g.: `{ \"filter_ids\" : [\"PSS000018\",\"PSS000070\"] }`. Example with curl: ``` curl -X GET 'https://www.pgscatalog.org/rest/sample_set/all' -H 'Content-type:application/json' -d '{ \"filter_ids\" : [\"PSS000018\", \"PSS000070\"] }' ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_sample_sets(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str filter_ids: Comma-separated list of PGS Sample Set IDs or JSON object with an array of PGS Sample Set IDs
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_sample_sets_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_all_sample_sets_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_all_sample_sets_with_http_info(self, **kwargs):  # noqa: E501
        """get_all_sample_sets  # noqa: E501

        Retrieve one Sample Set (group of samples used on a Performance Metric), including for each of them:   * List of samples     * Ancestry data     * Corresponding cohort(s)  Example of request: ``` https://www.pgscatalog.org/rest/sample_set/all ``` --- ###### **Filtering**  You can choose to filter the results of this endpoint to a specified list of sample sets by providing a list of PGS Sample Set IDs (PSS) in one of two ways: 1. A comma-seperated list of PSS IDs in the request URL (this will not work for larger queries), e.g.: ``` https://www.pgscatalog.org/rest/sample_set/all?filter_ids=PSS000018,PSS000070 ``` 2. A json-formatted list of IDs, e.g.: `{ \"filter_ids\" : [\"PSS000018\",\"PSS000070\"] }`. Example with curl: ``` curl -X GET 'https://www.pgscatalog.org/rest/sample_set/all' -H 'Content-type:application/json' -d '{ \"filter_ids\" : [\"PSS000018\", \"PSS000070\"] }' ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_sample_sets_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_sample_sets" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_cohorts(self, cohort_symbol, **kwargs):  # noqa: E501
        """get_cohorts  # noqa: E501

        Retrieve a Cohort, based on its symbol, including:   * Cohort full name   * Associated Polygenic Scores(s), with the distinction between associations with the Polygenic Score at the development phase or at the evaluation phase    Example of request:   ```   https://www.pgscatalog.org/rest/cohort/ABCFS   ```  __Notes__: A cohort symbol is not unique, therefore the API might return more than 1 result.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_cohorts(cohort_symbol, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str cohort_symbol: Short name of a cohort (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_cohorts_with_http_info(cohort_symbol, **kwargs)  # noqa: E501
        else:
            (data) = self.get_cohorts_with_http_info(cohort_symbol, **kwargs)  # noqa: E501
            return data

    def get_cohorts_with_http_info(self, cohort_symbol, **kwargs):  # noqa: E501
        """get_cohorts  # noqa: E501

        Retrieve a Cohort, based on its symbol, including:   * Cohort full name   * Associated Polygenic Scores(s), with the distinction between associations with the Polygenic Score at the development phase or at the evaluation phase    Example of request:   ```   https://www.pgscatalog.org/rest/cohort/ABCFS   ```  __Notes__: A cohort symbol is not unique, therefore the API might return more than 1 result.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_cohorts_with_http_info(cohort_symbol, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['cohort_symbol']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cohort_symbol' is set
        if ('cohort_symbol' not in params or
                params['cohort_symbol'] is None):
            raise ValueError("Missing the required parameter `cohort_symbol` when calling `get_cohorts`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'cohort_symbol' in params:
            path_params['cohort_symbol'] = params['cohort_symbol']  # noqa: E501
    ...
    def get_sample_set(self, pss_id, **kwargs):  # noqa: E501
        """get_sample_set  # noqa: E501

        Retrieve one Sample Set (group of samples used on a Performance Metric), including:   * List of samples     * Ancestry data     * Corresponding cohort(s)  Example of request: ``` https://www.pgscatalog.org/rest/sample_set/PSS000070 ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_sample_set(pss_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str pss_id: PGS Sample Set ID (PSS) (required)
        :return: SampleSet
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_sample_set_with_http_info(pss_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_sample_set_with_http_info(pss_id, **kwargs)  # noqa: E501
            return data

    def get_sample_set_with_http_info(self, pss_id, **kwargs):  # noqa: E501
        """get_sample_set  # noqa: E501

        Retrieve one Sample Set (group of samples used on a Performance Metric), including:   * List of samples     * Ancestry data     * Corresponding cohort(s)  Example of request: ``` https://www.pgscatalog.org/rest/sample_set/PSS000070 ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_sample_set_with_http_info(pss_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_sample_set" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'pss_id' is set
        if ('pss_id' not in params or
                params['pss_id'] is None):
            raise ValueError("Missing the required parameter `pss_id` when calling `get_sample_set`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'pss_id' in params:
            path_params['pss_id'] = params['pss_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='SampleSet',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def search_sample_set(self, **kwargs):  # noqa: E501
        """search_sample_set  # noqa: E501

        Search PGS Sample Sets using defined parameters (cf. \"Parameters\" section below).<br /> The parameters can be used directly in the request URL, e.g.: ``` https://www.pgscatalog.org/rest/sample_set/search?pgs_id=PGS000001 ``` This returns a list of PGS Sample Sets, including for each of them:   * List of samples     * Ancestry data     * Corresponding cohort(s)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_sample_set(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str pgs_id: Polygenic Score ID (PGS) - optional
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.search_sample_set_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.search_sample_set_with_http_info(**kwargs)  # noqa: E501
            return data

    def search_sample_set_with_http_info(self, **kwargs):  # noqa: E501
        """search_sample_set  # noqa: E501

        Search PGS Sample Sets using defined parameters (cf. \"Parameters\" section below).<br /> The parameters can be used directly in the request URL, e.g.: ``` https://www.pgscatalog.org/rest/sample_set/search?pgs_id=PGS000001 ``` This returns a list of PGS Sample Sets, including for each of them:   * List of samples     * Ancestry data     * Corresponding cohort(s)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_sample_set_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['pgs_id', 'pgp_id', 'pmid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method search_sample_set" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        query_params = []
        if 'pgs_id' in params:
            query_params.append(('pgs_id', params['pgs_id']))  # noqa: E501
        if 'pgp_id' in params:
