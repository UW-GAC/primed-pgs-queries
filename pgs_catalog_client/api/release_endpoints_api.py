...
class ReleaseEndpointsApi(object):
    ...
    def get_all_releases(self, **kwargs):  # noqa: E501
        """get_all_releases  # noqa: E501

        Retrieve all the PGS Releases (more recent first), including for each of them:   * The release date (format YYYY-MM-DD)   * The number of new Polygenic Scores, Publications and Performance Metrics   * The list of new Polygenic Scores, Publications and Performance Metrics IDs  Example of request: ``` https://www.pgscatalog.org/rest/release/all ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_releases(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_all_releases_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_all_releases_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_all_releases_with_http_info(self, **kwargs):  # noqa: E501
        """get_all_releases  # noqa: E501

        Retrieve all the PGS Releases (more recent first), including for each of them:   * The release date (format YYYY-MM-DD)   * The number of new Polygenic Scores, Publications and Performance Metrics   * The list of new Polygenic Scores, Publications and Performance Metrics IDs  Example of request: ``` https://www.pgscatalog.org/rest/release/all ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_releases_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def get_current_release(self, **kwargs):  # noqa: E501
        """get_current_release  # noqa: E501

        Retrieve the current PGS Release, including:   * The release date (format YYYY-MM-DD)   * The number of new Polygenic Scores, Publications and Performance Metrics   * The list of new Polygenic Scores, Publications and Performance Metrics IDs  Example of request: ``` https://www.pgscatalog.org/rest/release/current ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_current_release(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_current_release_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_current_release_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_current_release_with_http_info(self, **kwargs):  # noqa: E501
        """get_current_release  # noqa: E501

        Retrieve the current PGS Release, including:   * The release date (format YYYY-MM-DD)   * The number of new Polygenic Scores, Publications and Performance Metrics   * The list of new Polygenic Scores, Publications and Performance Metrics IDs  Example of request: ``` https://www.pgscatalog.org/rest/release/current ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_current_release_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_current_release" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_release(self, release_date, **kwargs):  # noqa: E501
        """get_release  # noqa: E501

        Retrieve a PGS Release information, including:   * The release date (format YYYY-MM-DD)   * The number of new Polygenic Scores, Publications and Performance Metrics   * The list of new Polygenic Scores, Publications and Performance Metrics IDs  Example of request: ``` https://www.pgscatalog.org/rest/release/2020-02-12 ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_release(release_date, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str release_date: PGS Catalog release date (format YYYY-MM-DD) (required)
        :return: Release
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_release_with_http_info(release_date, **kwargs)  # noqa: E501
        else:
            (data) = self.get_release_with_http_info(release_date, **kwargs)  # noqa: E501
            return data

    def get_release_with_http_info(self, release_date, **kwargs):  # noqa: E501
        """get_release  # noqa: E501

        Retrieve a PGS Release information, including:   * The release date (format YYYY-MM-DD)   * The number of new Polygenic Scores, Publications and Performance Metrics   * The list of new Polygenic Scores, Publications and Performance Metrics IDs  Example of request: ``` https://www.pgscatalog.org/rest/release/2020-02-12 ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_release_with_http_info(release_date, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['release_date']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('release_date' not in params or
            ...
            raise ValueError("Missing the required parameter `release_date` when calling `get_release`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'release_date' in params:
            path_params['release_date'] = params['release_date']  # noqa: E501
