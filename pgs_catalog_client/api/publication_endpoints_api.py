...
class PublicationEndpointsApi(object):
    ...
    def get_all_publications(self, **kwargs):  # noqa: E501
        """get_all_publications  # noqa: E501

        Retrieve all the PGS Publications, including for each of them:   * Pubmed ID and doi   * Publication title, journal, date and authors   * Associated Polygenic Score(s) with the distinction between associations with the Polygenic Score at the development phase or at the evaluation phase  Example of request: ``` https://www.pgscatalog.org/rest/publication/all ``` --- ###### **Filtering**  You can choose to filter the results of this endpoint to a specified list of studies by providing a list of PGS Publication IDs (PGP) in one of two ways: 1. A comma-seperated list of PGP IDs in the request URL (this will not work for larger queries), e.g.: ``` https://www.pgscatalog.org/rest/publication/all?filter_ids=PGP000001,PGP000018 ``` 2. A json-formatted list of IDs, e.g.: `{ \"filter_ids\" : [\"PGP000001\",\"PGP000018\"] }`. Example with curl: ``` curl -X GET 'https://www.pgscatalog.org/rest/publication/all' -H 'Content-type:application/json' -d '{ \"filter_ids\" : [\"PGP000001\", \"PGP000018\"] }' ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_publications(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str filter_ids: Comma-separated list of PGS Publication IDs or JSON object with an array of PGS Publication IDs
        ...
        if kwargs.get('async_req'):
            return self.get_all_publications_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_all_publications_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_all_publications_with_http_info(self, **kwargs):  # noqa: E501
        """get_all_publications  # noqa: E501

        Retrieve all the PGS Publications, including for each of them:   * Pubmed ID and doi   * Publication title, journal, date and authors   * Associated Polygenic Score(s) with the distinction between associations with the Polygenic Score at the development phase or at the evaluation phase  Example of request: ``` https://www.pgscatalog.org/rest/publication/all ``` --- ###### **Filtering**  You can choose to filter the results of this endpoint to a specified list of studies by providing a list of PGS Publication IDs (PGP) in one of two ways: 1. A comma-seperated list of PGP IDs in the request URL (this will not work for larger queries), e.g.: ``` https://www.pgscatalog.org/rest/publication/all?filter_ids=PGP000001,PGP000018 ``` 2. A json-formatted list of IDs, e.g.: `{ \"filter_ids\" : [\"PGP000001\",\"PGP000018\"] }`. Example with curl: ``` curl -X GET 'https://www.pgscatalog.org/rest/publication/all' -H 'Content-type:application/json' -d '{ \"filter_ids\" : [\"PGP000001\", \"PGP000018\"] }' ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_publications_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_all_publications" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_publication(self, pgp_id, **kwargs):  # noqa: E501
        """get_publication  # noqa: E501

        Retrieve a PGS Publication, including:   * Pubmed ID and doi   * Publication title, journal, date and authors   * Associated Polygenic Score(s) with the distinction between associations with the Polygenic Score at the development phase or at the evaluation phase  Example of request: ``` https://www.pgscatalog.org/rest/publication/PGP000001 ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_publication(pgp_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str pgp_id: PGS Publication ID (PGP) (required)
        :return: PublicationExtended
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_publication_with_http_info(pgp_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_publication_with_http_info(pgp_id, **kwargs)  # noqa: E501
            return data

    def get_publication_with_http_info(self, pgp_id, **kwargs):  # noqa: E501
        """get_publication  # noqa: E501

        Retrieve a PGS Publication, including:   * Pubmed ID and doi   * Publication title, journal, date and authors   * Associated Polygenic Score(s) with the distinction between associations with the Polygenic Score at the development phase or at the evaluation phase  Example of request: ``` https://www.pgscatalog.org/rest/publication/PGP000001 ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_publication_with_http_info(pgp_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'pgp_id' is set
        if ('pgp_id' not in params or
                params['pgp_id'] is None):
            raise ValueError("Missing the required parameter `pgp_id` when calling `get_publication`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'pgp_id' in params:
            path_params['pgp_id'] = params['pgp_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PublicationExtended',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def search_publications(self, **kwargs):  # noqa: E501
        """search_publications  # noqa: E501

        Search PGS Publications using defined parameters (cf. \"Parameters\" section below).<br /> The parameters can be used directly in the request URL, e.g.: ``` https://www.pgscatalog.org/rest/publication/search?pgs_id=PGS000001 ``` This returns a list of PGS Publications, including for each of them:   * Pubmed ID and doi   * Publication title, journal, data and authors   * Associated Polygenic Score(s) with the distinction between associations with the Polygenic Score at the development phase or at the evaluation phase   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_publications(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str pgs_id: Polygenic Score ID (PGS) - optional
        :param int pmid: PubMed ID (without the prefix \"PMID:\") - *optional*
        :param str author: Publication author (any author in the list of authors in a publication) - optional
        :return: InlineResponse2005
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.search_publications_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.search_publications_with_http_info(**kwargs)  # noqa: E501
            return data

    def search_publications_with_http_info(self, **kwargs):  # noqa: E501
        """search_publications  # noqa: E501

        Search PGS Publications using defined parameters (cf. \"Parameters\" section below).<br /> The parameters can be used directly in the request URL, e.g.: ``` https://www.pgscatalog.org/rest/publication/search?pgs_id=PGS000001 ``` This returns a list of PGS Publications, including for each of them:   * Pubmed ID and doi   * Publication title, journal, data and authors   * Associated Polygenic Score(s) with the distinction between associations with the Polygenic Score at the development phase or at the evaluation phase   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_publications_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['pgs_id', 'pmid', 'author']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method search_publications" % key
                )
            params[key] = val
        del params['kwargs']
