...
class PerformanceMetricEndpointsApi(object):
    ...
    def get_all_performances(self, **kwargs):  # noqa: E501
        """get_all_performances  # noqa: E501

        Retrieve all the PGS Performance Metrics, including for each of them:   * Performance metrics metadata (odd ratio, beta coefficient, C-index, ...)   * Reported phenotyping   * Associated Polygenic Score(s)   * Publication information   * List of samples used for the evaluation, with their ancestry and corresponding cohorts  Example of request: ``` https://www.pgscatalog.org/rest/performance/all ``` --- ###### **Filtering**  You can choose to filter the results of this endpoint to a specified list of performance metrics by providing a list of PGS Performance Metric IDs (PPM) in one of two ways: 1. A comma-seperated list of PPM IDs in the request URL (this will not work for larger queries), e.g.: ``` https://www.pgscatalog.org/rest/performance/all?filter_ids=PPM000001,PPM000002 ``` 2. A json-formatted list of IDs, e.g.: `{ \"filter_ids\" : [\"PPM000001\",\"PPM000002\"] }`. Example with curl: ``` curl -X GET 'https://www.pgscatalog.org/rest/performance/all' -H 'Content-type:application/json' -d '{ \"filter_ids\" : [\"PPM000001\", \"PPM000002\"] }' ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_performances(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str filter_ids: Comma-separated list of PGS Performance Metric IDs or JSON object with an array of PGS Performance Metric IDs
        ...
        if kwargs.get('async_req'):
            return self.get_all_performances_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_all_performances_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_all_performances_with_http_info(self, **kwargs):  # noqa: E501
        """get_all_performances  # noqa: E501

        Retrieve all the PGS Performance Metrics, including for each of them:   * Performance metrics metadata (odd ratio, beta coefficient, C-index, ...)   * Reported phenotyping   * Associated Polygenic Score(s)   * Publication information   * List of samples used for the evaluation, with their ancestry and corresponding cohorts  Example of request: ``` https://www.pgscatalog.org/rest/performance/all ``` --- ###### **Filtering**  You can choose to filter the results of this endpoint to a specified list of performance metrics by providing a list of PGS Performance Metric IDs (PPM) in one of two ways: 1. A comma-seperated list of PPM IDs in the request URL (this will not work for larger queries), e.g.: ``` https://www.pgscatalog.org/rest/performance/all?filter_ids=PPM000001,PPM000002 ``` 2. A json-formatted list of IDs, e.g.: `{ \"filter_ids\" : [\"PPM000001\",\"PPM000002\"] }`. Example with curl: ``` curl -X GET 'https://www.pgscatalog.org/rest/performance/all' -H 'Content-type:application/json' -d '{ \"filter_ids\" : [\"PPM000001\", \"PPM000002\"] }' ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_performances_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_all_performances" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_performance_metric(self, ppm_id, **kwargs):  # noqa: E501
        """get_performance_metric  # noqa: E501

        Retrieve a PGS Performance Metric, including:   * Performance metrics metadata (odd ratio, beta coefficient, C-index, ...)   * Reported phenotyping   * Associated Polygenic Score(s)   * Publication information   * List of samples used for the evaluation, with their ancestry and corresponding cohorts  Example of request: ``` https://www.pgscatalog.org/rest/performance/PPM000001 ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_performance_metric(ppm_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str ppm_id: PGS Performance Metric ID (PPM) (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_performance_metric_with_http_info(ppm_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_performance_metric_with_http_info(ppm_id, **kwargs)  # noqa: E501
            return data

    def get_performance_metric_with_http_info(self, ppm_id, **kwargs):  # noqa: E501
        """get_performance_metric  # noqa: E501

        Retrieve a PGS Performance Metric, including:   * Performance metrics metadata (odd ratio, beta coefficient, C-index, ...)   * Reported phenotyping   * Associated Polygenic Score(s)   * Publication information   * List of samples used for the evaluation, with their ancestry and corresponding cohorts  Example of request: ``` https://www.pgscatalog.org/rest/performance/PPM000001 ```   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_performance_metric_with_http_info(ppm_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            ...
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'ppm_id' is set
        if ('ppm_id' not in params or
                params['ppm_id'] is None):
            raise ValueError("Missing the required parameter `ppm_id` when calling `get_performance_metric`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'ppm_id' in params:
            path_params['ppm_id'] = params['ppm_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PerformanceMetric',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def search_performance_metrics(self, **kwargs):  # noqa: E501
        """search_performance_metrics  # noqa: E501

        Search PGS Performance Metrics using defined parameters (cf. \"Parameters\" section below).<br /> The parameters can be used directly in the request URL, e.g.: ``` https://www.pgscatalog.org/rest/performance/search?pgs_id=PGS000001 ``` This returns a list of PGS Performance Metrics, including for each of them:   * Performance metrics metadata (odd ratio, beta coefficient, C-index, ...)   * Reported phenotyping   * Associated Polygenic Score(s)   * Publication information   * List of samples used for the evaluation, with their ancestry and corresponding cohorts   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_performance_metrics(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.search_performance_metrics_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.search_performance_metrics_with_http_info(**kwargs)  # noqa: E501
            return data

    def search_performance_metrics_with_http_info(self, **kwargs):  # noqa: E501
        """search_performance_metrics  # noqa: E501

        Search PGS Performance Metrics using defined parameters (cf. \"Parameters\" section below).<br /> The parameters can be used directly in the request URL, e.g.: ``` https://www.pgscatalog.org/rest/performance/search?pgs_id=PGS000001 ``` This returns a list of PGS Performance Metrics, including for each of them:   * Performance metrics metadata (odd ratio, beta coefficient, C-index, ...)   * Reported phenotyping   * Associated Polygenic Score(s)   * Publication information   * List of samples used for the evaluation, with their ancestry and corresponding cohorts   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_performance_metrics_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method search_performance_metrics" % key
                )
            params[key] = val
        del params['kwargs']
